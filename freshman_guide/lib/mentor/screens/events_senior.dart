...
import 'package:freshman_guide/mentor/screens/eventdetails_senior.dart'; // Placeholder for senior event details

class EventsSeniorScreen extends StatefulWidget {
  const EventsSeniorScreen({super.key});

  @override
  State<EventsSeniorScreen> createState() => _EventsSeniorScreenState();
}

class _EventsSeniorScreenState extends State<EventsSeniorScreen> {
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
      // Already on EventsSeniorScreen, no navigation needed
        break;
      case 3:
        Navigator.pushReplacement(
          context,
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _buildEventButton('Tech Innovation Summit', 'Explore the latest tech trends and innovations.', () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const EventDetailsSeniorScreen()),
                        );
                      }),
