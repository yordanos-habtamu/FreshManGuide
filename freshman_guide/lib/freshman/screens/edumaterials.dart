...
class EducationalMaterialsScreen extends StatefulWidget {
  const EducationalMaterialsScreen({super.key});

  @override
  State<EducationalMaterialsScreen> createState() => _EducationalMaterialsScreenState();
}

class _EducationalMaterialsScreenState extends State<EducationalMaterialsScreen> {
