...
class DepartmentContactsScreen extends StatefulWidget {
  const DepartmentContactsScreen({super.key});

  @override
  State<DepartmentContactsScreen> createState() => _DepartmentContactsScreenState();
}

class _DepartmentContactsScreenState extends State<DepartmentContactsScreen> {
