...
class SpecificAlumniScreen extends StatefulWidget {
  ...
  @override
  State<SpecificAlumniScreen> createState() => _SpecificAlumniScreenState();
}

class _SpecificAlumniScreenState extends State<SpecificAlumniScreen> {
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      '${widget.followers} Followers  ${widget.friends} Friends',
                      style: GoogleFonts.poppins(
                        fontSize: 14,
